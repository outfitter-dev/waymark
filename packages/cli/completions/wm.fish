...
# Commands
complete -c wm -n "__fish_use_subcommand" -a "format" -d "Format waymarks in a file"
complete -c wm -n "__fish_use_subcommand" -a "insert" -d "Insert waymarks into files"
complete -c wm -n "__fish_use_subcommand" -a "remove" -d "Remove waymarks from files"
complete -c wm -n "__fish_use_subcommand" -a "modify" -d "Modify existing waymarks"
complete -c wm -n "__fish_use_subcommand" -a "lint" -d "Validate waymark structure"
complete -c wm -n "__fish_use_subcommand" -a "migrate" -d "Migrate legacy comments"
complete -c wm -n "__fish_use_subcommand" -a "init" -d "Initialize waymark config"
complete -c wm -n "__fish_use_subcommand" -a "update" -d "Update CLI to latest version"
complete -c wm -n "__fish_use_subcommand" -a "help" -d "Display help for command"
...
complete -c wm -n "__fish_seen_subcommand_from format" -F
...
complete -c wm -n "__fish_seen_subcommand_from modify" -l type -d "Change waymark type" -a "todo fix note warn tldr done"
...
complete -c wm -n "__fish_seen_subcommand_from lint" -F

# Migrate command
complete -c wm -n "__fish_seen_subcommand_from migrate" -s w -l write -d "Write changes to file"
complete -c wm -n "__fish_seen_subcommand_from migrate" -F
...
complete -c wm -n "__fish_seen_subcommand_from update" -l command -d "Override update command"
...
complete -c wm -n "__fish_use_subcommand" -s t -l type -d "Filter by waymark type" -a "todo fix wip done review test check note context tldr this example idea comment warn alert deprecated temp hack blocked needs question"
...
complete -c wm -n "__fish_use_subcommand" -s C -l context -d "Context lines"
complete -c wm -n "__fish_use_subcommand" -s A -l after -d "Lines after"
complete -c wm -n "__fish_use_subcommand" -s B -l before -d "Lines before"
complete -c wm -n "__fish_use_subcommand" -l limit -d "Limit results"
complete -c wm -n "__fish_use_subcommand" -l page -d "Page number"

# Enable file completion for paths
complete -c wm -n "__fish_use_subcommand" -F
