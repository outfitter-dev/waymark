...
Register-ArgumentCompleter -Native -CommandName 'wm' -ScriptBlock {
    ...
    $completions = @(switch ($command) {
        ...
        'wm;modify' {
            ...
            [CompletionResult]::new('--mark-starred', 'mark-starred', [CompletionResultType]::ParameterName, 'Add starred signal')
            [CompletionResult]::new('--clear-signals', 'clear-signals', [CompletionResultType]::ParameterName, 'Remove all signals')
        ...
        'wm;remove' {
            ...
            [CompletionResult]::new('--tag', 'tag', [CompletionResultType]::ParameterName, 'Filter by hashtag')
            [CompletionResult]::new('--mention', 'mention', [CompletionResultType]::ParameterName, 'Filter by mention')
            [CompletionResult]::new('--property', 'property', [CompletionResultType]::ParameterName, 'Filter by property')
            [CompletionResult]::new('--file', 'file', [CompletionResultType]::ParameterName, 'Filter by file pattern')
            [CompletionResult]::new('--content-pattern', 'content-pattern', [CompletionResultType]::ParameterName, 'Filter by content regex')
            [CompletionResult]::new('--contains', 'contains', [CompletionResultType]::ParameterName, 'Filter by content substring')
            [CompletionResult]::new('--raised', 'raised', [CompletionResultType]::ParameterName, 'Filter by raised signal')
            [CompletionResult]::new('--starred', 'starred', [CompletionResultType]::ParameterName, 'Filter by starred signal')
